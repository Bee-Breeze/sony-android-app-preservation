...
External monitor、Bluetooth Headset SBH56、5G Data Collector 與 Sony Power Optimizer
建立完整的公開範本。
...
| 164 | [Concept Installer](apps/concept-installer-1.3.0/) | 1.3.0 full-aspect v1 | 有限制通過：終止服務錯誤頁與唯一按鈕穩定，後端已退役 | 失敗：缺少 `com.sony.device` | PARTIAL 僅證據；APK 僅私人發佈 |
